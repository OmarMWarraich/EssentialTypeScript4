    ...
    loadProducts(): Promise<Product[]> {
        return Promise.resolve([
            ...
            description: "P3 (Running)", price: 5},
                ...
                description: "P4 (Watersports)", price: 6},
...
// This class uses the Promise.resolve method to create a Prmoise that immediately 
// produces a response and allows test data to be easily used. 